...
typedef int (*NonlinSolverInvoke) (Vector *pressure, Vector *density, Vector *old_density, Vector *saturation, Vector *old_saturation, double t, double dt, ProblemData *problem_data, Vector *old_pressure, Vector *evap_trans, Vector *ovrl_bc_flx, Vector *ice_fraction, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
int KinsolNonlinSolver(Vector *pressure, Vector *density, Vector *old_density, Vector *saturation, Vector *old_saturation, double t, double dt, ProblemData *problem_data, Vector *old_pressure, Vector *evap_trans, Vector *ovrl_bc_flx, Vector *ice_fraction, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
typedef void (*NlFunctionEvalInvoke) (Vector *pressure, Vector *fval, ProblemData *problem_data, Vector *saturation, Vector *old_saturation, Vector *density, Vector *old_density, double dt, double time, Vector *old_pressure, Vector *evap_trans, Vector *ovrl_bc_flx, Vector *ice_fraction, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
void NlFunctionEval(Vector *pressure, Vector *fval, ProblemData *problem_data, Vector *saturation, Vector *old_saturation, Vector *density, Vector *old_density, double dt, double time, Vector *old_pressure, Vector *evap_trans, Vector *ovrl_bc_flx, Vector *ice_fraction, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
typedef void (*PhaseRelPermInvoke) (Vector *phase_rel_perm, Vector *phase_pressure, Vector *phase_density, Vector *ice_fraction, double gravity, ProblemData *problem_data, int fcn);
typedef PFModule *(*PhaseRelPermInitInstanceXtraInvoke) (Grid *grid, double *temp_data);

/* problem_phase_rel_perm.c */
void PhaseRelPerm(Vector *phase_rel_perm, Vector *phase_pressure, Vector *phase_density, Vector *ice_fraction, double gravity, ProblemData *problem_data, int fcn);
