...
typedef int (*NonlinSolverInvoke) (Vector *pressure, Vector *density, Vector *old_density, Vector *saturation, Vector *old_saturation, double t, double dt, ProblemData *problem_data, Vector *old_pressure, Vector *evap_trans, Vector *ice_impedance, Vector *ovrl_bc_flx, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
int KinsolNonlinSolver(Vector *pressure, Vector *density, Vector *old_density, Vector *saturation, Vector *old_saturation, double t, double dt, ProblemData *problem_data, Vector *old_pressure, Vector *evap_trans, Vector *ice_impedance, Vector *ovrl_bc_flx, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
typedef PFModule * (*KinsolPCInitInstanceXtraInvoke) (Problem *problem, Grid *grid, ProblemData *problem_data, double *temp_data, Vector *pressure, Vector *old_pressure, Vector *saturation, Vector *density, Vector *ice_impedance, double dt, double time);
typedef PFModule *(*KinsolPCNewPublicXtraInvoke) (char *name, char *pc_name);

/* kinsol_pc.c */
void KinsolPC(Vector *rhs);
PFModule *KinsolPCInitInstanceXtra(Problem *problem, Grid *grid, ProblemData *problem_data, double *temp_data, Vector *pressure, Vector *old_pressure, Vector *saturation, Vector *density, Vector *ice_impedance, double dt, double time);
...
typedef void (*NlFunctionEvalInvoke) (Vector *pressure, Vector *fval, ProblemData *problem_data, Vector *saturation, Vector *old_saturation, Vector *density, Vector *old_density, double dt, double time, Vector *old_pressure, Vector *evap_trans, Vector *ice_impedance, Vector *ovrl_bc_flx, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
void NlFunctionEval(Vector *pressure, Vector *fval, ProblemData *problem_data, Vector *saturation, Vector *old_saturation, Vector *density, Vector *old_density, double dt, double time, Vector *old_pressure, Vector *evap_trans, Vector *ice_impedance, Vector *ovrl_bc_flx, Vector *x_velocity, Vector *y_velocity, Vector *z_velocity);
...
typedef void (*PhaseRelPermInvoke) (Vector *phase_rel_perm, Vector *phase_pressure, Vector *phase_density, Vector *ice_impedance, double gravity, ProblemData *problem_data, int fcn);
typedef PFModule *(*PhaseRelPermInitInstanceXtraInvoke) (Grid *grid, double *temp_data);

/* problem_phase_rel_perm.c */
void PhaseRelPerm(Vector *phase_rel_perm, Vector *phase_pressure, Vector *phase_density, Vector *ice_impedance, double gravity, ProblemData *problem_data, int fcn);
...
typedef void (*RichardsJacobianEvalInvoke) (Vector *pressure, Vector *old_pressure, Matrix **ptr_to_J, Matrix **ptr_to_JC, Vector *saturation, Vector *density, Vector *ice_impedance, ProblemData *problem_data, double dt, double time, int symm_part);
...
void RichardsJacobianEval(Vector *pressure, Vector *old_pressure, Matrix **ptr_to_J, Matrix **ptr_to_JC, Vector *saturation, Vector *density, Vector *ice_impedance, ProblemData *problem_data, double dt, double time, int symm_part);
