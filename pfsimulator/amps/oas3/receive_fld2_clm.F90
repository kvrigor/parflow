SUBROUTINE receive_fld2_clm(evap_trans,ice_impedance,topo,ix,iy,nx,ny,nz,nx_f,ny_f,pstep)
...
REAL(KIND=8), INTENT(INOUT)        :: ice_impedance((nx+2)*(ny+2)*(nz+2))! soil ice fraction
